...
test.describe('Layouts - Connect Pay Tombstone Buttons Stacked', () => {
  ...
  test('Layout loads with expected visuals', async ({ page }) => {
    await page.goto('./examples/layouts/ConnectPayTombstoneButtonsStacked')
    await page.waitForURL('*/**/examples/layouts/ConnectPayTombstoneButtonsStacked')
